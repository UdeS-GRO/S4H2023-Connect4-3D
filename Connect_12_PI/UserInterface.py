...
def userInterface(self):
    ...
    self.submit_button6 = QPushButton("Reset pick 45 deg")
    self.submit_button6.clicked.connect(self.submit_man_resetPick45deg)
    self.submit_button7 = QPushButton("Reset pick 90 deg")
    self.submit_button7.clicked.connect(self.submit_man_resetPick90deg)
